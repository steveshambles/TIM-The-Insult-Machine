...
root = Tk()
root.title('TIM-The Insult Machine V1.90-WL')


def about_menu():
    """About program."""
    messagebox.showinfo('Nosey Aint ya', 'The Insult Machine V1.90-WL\n\n'
...
def change_lang(clang):
    ...
    # This bit of code looks horrific, but i needed to do it this
    # way first to make sure it works then I can learn later how
